...
echo_and_run cd "/home/ubuntu/environment/robot/src/turtlebot3/turtlebot3_teleop"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/ubuntu/environment/robot/src/turtlebot3/turtlebot3_teleop/setup.py" \
     \
    build --build-base "/home/ubuntu/environment/robot/build/turtlebot3/turtlebot3_teleop" \
    install \
    --root="${DESTDIR-/}" \
